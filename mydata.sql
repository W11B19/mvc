...
--
-- Хост: 127.0.0.1:3366
-- Время создания: Апр 07 2020 г., 18:51
...
--
ALTER TABLE `h4t98hf47r_users`
  MODIFY `id` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id пользователя';
COMMIT;
